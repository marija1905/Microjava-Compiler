...
public class ConditionList_node extends ConditionList {

    private ConditionList ConditionList;
    private CondTerm CondTerm;

    public ConditionList_node (ConditionList ConditionList, CondTerm CondTerm) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConditionList_node(\n");
